...
from .alpha_vantage_source import (
...
class DataInterface:
    """High-level data interface that wraps route_to_vendor for convenience."""

    def __init__(self, config=None):
        pass

    def get_stock_data(self, ticker: str, period: str = "6mo") -> dict:
        return route_to_vendor("get_stock_data", ticker, period=period)

    def get_indicators(self, ticker: str, period: str = "1y") -> dict:
        return route_to_vendor("get_indicators", ticker, period=period)
    ...
    def get_news(self, query: str, max_results: int = 10) -> list:
        return route_to_vendor("get_news", query, max_results=max_results)

...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 flex w-56 flex-col border-r border-border-subtle bg-surface-1">
      ...
      <div className="border-t border-border-subtle px-4 py-3">
        <p className="text-2xs text-text-tertiary">SimuAlpha v0.1.0</p>
      </div>
    </aside>
  );
}

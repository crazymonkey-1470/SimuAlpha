...
const SHORTCUTS = [
  ...
  { keys: ['g', 'w'], label: 'Go to Watchlist', action: 'nav', path: '/watchlist' },
  { keys: ['g', 'p'], label: 'Go to Portfolio', action: 'nav', path: '/portfolio' },
  { keys: ['g', 'i'], label: 'Go to Intelligence', action: 'nav', path: '/intelligence' },
  { keys: ['g', 'c'], label: 'Go to Consensus', action: 'nav', path: '/consensus' },
